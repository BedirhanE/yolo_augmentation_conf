...
class RandomFlip:
    ...
    def __init__(self, p=0.75, direction="horizontal", flip_idx=None) -> None:
        """
    ...
    def __init__(self, p=1.0):
        ...
        try:
            ...
            T = [
                ...
                A.ElasticTransform(alpha=1.78, sigma=10.74, alpha_affine=95.30, interpolation=2, border_mode=4, value=None, mask_value=None, always_apply=False, approximate=False, same_dxdy=False, p=0.5),
                A.ISONoise(color_shift=(0.17, 0.48), intensity=(0.86, 1.52), always_apply=False, p=0.5),
                A.Downscale(scale_min=0.23, scale_max=0.68, interpolation=1, always_apply=False, p=0.5),
                A.HueSaturationValue(hue_shift_limit=-74 , sat_shift_limit=40, val_shift_limit=30, always_apply=False, p=0.5),
                A.GaussNoise(var_limit=(120.81, 409.40), mean=10, per_channel=True, always_apply=False, p=0.5),
                A.Rotate (limit=24, interpolation=3, border_mode=4, value=None, mask_value=None, rotate_method='largest_box', crop_border=False, always_apply=False, p=0.5),
                A.RGBShift (r_shift_limit=-22, g_shift_limit=47, b_shift_limit=-29, always_apply=False, p=0.5),
                A.LongestMaxSize(max_size=320, interpolation=2, always_apply=False, p=1),
